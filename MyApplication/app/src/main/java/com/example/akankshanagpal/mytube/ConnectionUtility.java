...
public class ConnectionUtility {
    ...
    //This method is used to get response from youtube data api in form of JSONObject
    public static ArrayList<String> fetchResponse(String url, String reqParam, String accessToken)
    {
